...
| `return_type_name` | string | yes |  | Data type to return, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int) |
...
| `type_name` | string |  |  | Data type to assign, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int); omit to keep the current one. Not valid on an external import. |
...
| `type_name` | string | yes |  | Data type to assign, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int) |
...
| `type_name` | string |  |  | Data type to assign, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int); omit to keep the current one. |
...
| `type_name` | string | yes |  | Field data type, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int) |
...
| `type_name` | string | yes |  | Replacement field data type, e.g. int, char *, MyStruct *, or a callback declarator int (*)(void *, int) |
